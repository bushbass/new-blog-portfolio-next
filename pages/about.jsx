    ...
    <main className="main">
      ...
      <div>
        ...
        <p>
          ...
          tried out a few other career paths, but I&apos;ve always come back to
          web development. Not long ago I decided to try to keep pace with the
          new technologies in web development and I've been doing projects to
          showcase my skills.{' '}
        ...
        <p>
          ...
          JavaScript and React. I&apos;m not a Node expert but I can get a REST
          API running with Express.
        </p>
        <p>
          I&apos;ve been at home taking care of the kids the past few years but
          now I&apos;m ready to make a move back into full-time. Ideally I'd
          like to be working in music/entertainment or education (I spent a few
          years teaching music), but I would be very happy working anywhere that
          has a supportive team and that will allow me to continue learning and
          growing my skills.{' '}
        </p>
        <p>
          ...
          my vegetable garden (and attempting to keep the deer out of it) and my
